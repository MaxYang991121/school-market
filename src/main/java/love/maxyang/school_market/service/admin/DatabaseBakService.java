...
import love.maxyang.school_market.dao.admin.DatabaseBakDao;
...
public class DatabaseBakService {
	...
	@Value("${market.database.backup.dir}")
	private String backUpDir;
	@Value("${market.database.backup.username}")
	private String dbUsername;
	@Value("${market.database.backup.password}")
	private String dbPwd;
	@Value("${market.database.backup.database.name}")

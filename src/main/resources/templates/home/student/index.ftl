...
<div class="top clearfix" id ="user-top">
    ...
    <div id="user_photo">
          	<#if market_studnet.headPic??>
          	<img id="origin_ph" onClick="openUploadPanel()" src="/photo/view?filename=${market_studnet.headPic}" old-src="/photo/view?filename=${market_studnet.headPic}" alt="大头像">
			<#else>
        ...
        <div id="my_info">
            <div id="account_info">
				...
				<ul class="infos" id="userid">
					<li>账号ID</li><li class="right_info">${market_studnet.id}</li>
				</ul>
			    <ul class="infos" id="userstate">
				    <li>账号状态</li>
				    <li class="right_info"><#if market_studnet.status == 1>正常<#else>冻结</#if></li>
				</ul>
			</div>
            <div id="account_info">
                <ul class="infos">
                    <li>学号</li>
                    <li class="right_info">${market_studnet.sn}</li>
                </ul>
            </div>
            <div id="base_info">
            ...
            <div id="base_info">
                ...
                <ul class="infos">
                    <li>昵称</li>
                    <li class="right_info">
                        <span class="baseinfo" id="nickname_span">${market_studnet.nickname!""}</span>
                        <input class="baseinfo" value="${market_studnet.nickname!""}" id="nickname" type="text">
                    </li> 
                </ul>
                <ul class="infos">
                    <li>手机</li>
                    <li class="right_info">
                        <span class="baseinfo" id="phone_span">${market_studnet.mobile!""}</span>
                        <input class="baseinfo" value="${market_studnet.mobile!""}" id="mobile" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>QQ</li>
                    <li class="right_info">
                        <span class="baseinfo" id="qq_span">${market_studnet.qq!""}</span>
                        <input class="baseinfo" value="${market_studnet.qq!""}" id="qq" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>学院</li>
                    <li class="right_info">
                        <span class="baseinfo" id="college_span">${market_studnet.academy!""}</span>
                        <input class="baseinfo" value="${market_studnet.academy!""}" id="academy" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>年级</li>
                    <li class="right_info">
                        <span class="baseinfo" id="grade_span">${market_studnet.grade!""}</span>
                        <input class="baseinfo" value="${market_studnet.grade!""}" id="grade" type="text">
                    </li>
                </ul>
                <ul class="infos">
                    <li>学校</li>
                    <li class="right_info">
                        <span class="baseinfo" id="area_span">${market_studnet.school!""}</span>
                        <input class="baseinfo" value="${market_studnet.school!""}" id="school" type="text">
                    </li>
                </ul>
            </div>
        </div>

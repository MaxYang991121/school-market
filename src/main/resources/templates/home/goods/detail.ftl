                       ...
                       <!-- 轮播大图-->
                        <div class="bigger-photo-box">
                        	<a class="bigger-photo hide show" rel="img_group" href="">
                        		<img class="bigger" src="/photo/view?filename=${goods.photo}"  alt="${goods.name}" style="width:100px;height:100px;">
                        	</a>
                        </div>
                </div>
				...
				<div class="comments-wr" style="border-left:0px;">
					<div class="comment-wr">
						<div class="post-comment clearfix">
								...
								<img class="avatar" src="/photo/view?filename=${market_studnet.headPic}" alt="头像"/>
								<#else>
...
$(document).ready(function(){
   $("#buy-button").click(function(){
		<#if market_studnet??>
		alert("请您联系卖家购买商品。"+"\n"+"电话:${market_studnet.mobile!""}\n"+"QQ:${market_studnet.qq!""}");
		<#else>
		alert("请您先登录");
